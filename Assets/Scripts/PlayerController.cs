...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] float moveSpeed, upToMoveSpeed, mouseSmoothing, gravity, jumpVelocity, playerJumpVelocity; // set in editor for controlling
    ...
    void FixedUpdate()
    {
        ...
        // lerp our values into position
        moveV = Vector3.Lerp(moveV ,playerHead.forward * pAxisV, upToMoveSpeed * Time.fixedDeltaTime);
        moveH = Vector3.Lerp(moveH, playerHead.right * pAxisH, upToMoveSpeed * Time.fixedDeltaTime);
        ...
        // lerp our horizontal movement speed
        ...
        Mathf.SmoothStep(xRotate, finalxRotate, mouseSmoothing * Time.fixedDeltaTime);
        Mathf.SmoothStep(yRotate, finalyRotate, mouseSmoothing * Time.fixedDeltaTime);
